        ...
        button_insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(textView.getText().toString()!=null){
                    ...
                    word.setMeaning(textView.getText().toString());
                    word.setSample("无");
                    word.save();
                    //wordsDB.Insert(editText.getText().toString(),textView.getText().toString(), "暂无");
                    //RefreshWordItemFragment();
                    Toast.makeText(Translate_Activity.this,"添加成功",Toast.LENGTH_SHORT).show();
                }
                else if(textView.getText().toString()==null)
                    Toast.makeText(Translate_Activity.this,"输入为空",Toast.LENGTH_SHORT).show();
            }
        });
